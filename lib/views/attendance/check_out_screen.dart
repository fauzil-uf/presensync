...
class _CheckOutScreenState extends State<CheckOutScreen> {
  ...
  Future<void> _submitCheckOut() async {
    ...
    try {
      final success = await attProv.checkOut(
      ...
      if (success) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Absen pulang berhasil dicatat. Terima kasih!'),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content:
                Text(attProv.errorMessage ?? 'Gagal melakukan absen pulang'),
            backgroundColor: AppColors.error,
          ),
        );
      }
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // 1. Live Accurate Server Time Banner (Sleek Info Gradient)
              Container(
              ...
              // Section Header
              Text(
                'Verifikasi Radar Lokasi Pulang',
                style: TextStyle(
                  fontSize: 15.5,
                  fontWeight: FontWeight.w800,
                  color: isDark
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Mendeteksi sinyal GPS & radius kampus...',
                          style: TextStyle(
                            fontSize: 13,
              ...
              if (attProv.hasCheckedOutToday) ...[
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Anda sudah menyelesaikan presensi pulang hari ini (${attProv.todayAttendance?.checkOutTime ?? "--:--"} WIB).',
                          style: TextStyle(
                            fontSize: 12.5,
                            fontWeight: FontWeight.w600,
                            color: isDark
              ...
              ] else if (!attProv.hasCheckedInToday) ...[
                Container(
                  width: double.infinity,
                  padding: const EdgeInsets.all(14),
                  decoration: BoxDecoration(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Silakan lakukan presensi masuk terlebih dahulu sebelum mencatat kepulangan.',
                          style: TextStyle(
                            fontSize: 12.5,
                            fontWeight: FontWeight.w600,
                            color: isDark
                ...
                CustomButton(
                  text: 'Konfirmasi Presensi Pulang',
